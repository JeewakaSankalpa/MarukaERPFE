            ...
            {selectedProduct && (
                <>
                    ...
                    <div>
                        ...
                        <input type="text" name="batchNumber" value={inventoryData.batchNumber} onChange={handleChange} />
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="number" name="sellingPrice" value={inventoryData.sellingPrice} onChange={handleChange} />
                    </div>
